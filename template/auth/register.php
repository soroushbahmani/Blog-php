    ...
    <body>
        ...
        <section class="container-fluid bg-auth-form d-flex justify-content-center align-items-center ">
            <section class="row bg-gradiant-green-blue">
                ...
                <section class="col-12 bg-white p-5 rounded">
                    ...
                    <form method="post" action="http://localhost/blog/register/store">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <a href="http://localhost/blog/login" class="btn btn-sm mx-0 btn-success">LOGIN</a>
        ...
        <script type="text/javascript">
            ...
            ?>
            <?php if ($httpReferer == 'http://localhost/blog/register') { ?>
                swal({
