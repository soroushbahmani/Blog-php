            ...
            <main class="main">
                <section class="main-news">
                    ...
                    <article>
                        ...
                        <img class="main-news-img" src="http://localhost/blog/<?php echo $article['image']; ?>" alt="">
                        <h3 class="article-title">
                            <a href="http://localhost/blog/show-article/1"><?php echo $article['title']; ?></a>
                        </h3>
                        <ul class="info-bar">
                    ...
                    <?php }
                     if(isset($_SESSION['user'])){
                        ...
                        <form action="http://localhost/blog/comment-store" method="post">
