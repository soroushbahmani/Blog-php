...
<section class="row my-3">
    <section class="col-12">
        ...
        <form method="post" action="http://localhost/blog/web-setting/store" enctype="multipart/form-data">
           ...
           <div class="form-group">
           <?php if($setting !=null){ ?>
                    <img style="width: 100px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/blog/'.$setting['logo']; ?>" alt="" >
                <hr/>
                <?php } ?>
            ...
            <div class="form-group">
            <?php if($setting !=null){ ?>
                    <img style="width: 100px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/blog/'.$setting['icon']; ?>" alt="" >
                <hr/>
                <?php } ?>
