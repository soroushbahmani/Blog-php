...
?>
    <div class="row mt-3">
        ...
        <div class="col-lg-5 mx-auto col-md-6 col-12">
            <a href="http://localhost/blog/category" class="text-decoration-none">
        ...
        <div class="col-lg-5 col-md-6 mx-auto col-12">
            <a href="http://localhost/blog/user" class="text-decoration-none">
        ...
        <div class="col-lg-5 mx-auto ol-md-6 col-12">
            <a href="http://localhost/blog/article" class="text-decoration-none">
        ...
        <div class="col-lg-5 mx-auto col-md-6 col-12">
            <a href="http://localhost/blog/comment" class="text-decoration-none">
        ...
        <div class="col-lg-4 col-md-9 col-12 mx-auto">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        <td><a class="text-primary" href="http://localhost/blog/article/show/<?php echo  $article['id'] ?>"><?php echo  $article['id'] ?></a></td>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <?php foreach($lastComments as $comment) {?>
                        ...
                        <tr>
                            <td><a class="text-primary" href="http://localhost/blog/comment/show/<?php echo  $comment['id'] ?>"><?php echo  $comment['id'] ?></a></td>
